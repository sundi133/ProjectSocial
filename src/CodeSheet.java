...
public class CodeSheet {
	...
	public void CodeSheet(){
		...
		try {
			...
			FileInputStream fstream1 = new FileInputStream("C:\\Users\\sundi133\\Downloads\\spain\\CodebookCodes.doc");
	...
	public String translate(String param){
		...
		try {
			translatedText = Translate.execute(param, Language.AUTO_DETECT, Language.ENGLISH);
